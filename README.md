...
Installation instructions and samples using the official Python wrappers for OpenNI2 and OpenCV. Build and installation instructionsa dapted from [Occipital](https://github.com/occipital/OpenNI2)
